...
module.exports.html2 = '"/><div style="text-align: center">인증을 받으시려면 <a href="220.230.114.8:3444/admin/comfirm/';
module.exports.html3 =	'">"인증하기"</a>를 눌러주세요.<br></div><div style="text-align: center; margin-bottom: 15px;">'+
		'인증을 거절하시려면<a href="220.230.114.8:3444/admin/reject/';
module.exports.html4 = '">"거절하기"</a>를 눌러주세요.</div></div></body></html>'
